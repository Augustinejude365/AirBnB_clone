...
class HBNBCommand(cmd.Cmd):
    ...
    def do_destroy(self, args):
        """
        This line of codes deletes an instance based on the class
        name and id
        """
        args = args.split()
        if len(args) == 0:
    ...
    def do_all(self, args):
        """
        This lines of code prints all string representation of all
    ...
    def do_update(self, args):
        """
        This lines of code updates an instance based on the class
                ...
                if args[0] in self.allowed_classes:
                    ...
                    if identifier in list(models.storage.all().keys()):
                        if len(args) == 2:
                            ...
                            attr = args[2]
                            value = args[3]
                            setattr(models.storage.all()[identifier],
                                    attr, value)
